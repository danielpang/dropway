...
/**
 * Auth route-group shell: a quiet, theme-aware backdrop (subtle dot grid +
 * radial wash) with the centered card slotted in by each page. The auth screens
 * are first-impression surfaces, so this stays minimal and polished.
 */
