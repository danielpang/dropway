...
func (q *Queries) AllocateChatSeq(ctx context.Context, arg AllocateChatSeqParams) (int32, error) {
	row := q.db.QueryRow(ctx, allocateChatSeq, arg.ID, arg.Column2)
	var base_seq int32
...
func (q *Queries) CountChatMessages(ctx context.Context, chatLogID string) (int64, error) {
	row := q.db.QueryRow(ctx, countChatMessages, chatLogID)
	var n int64
	err := row.Scan(&n)
	return n, err
}
...
func (q *Queries) DeleteChatLog(ctx context.Context, id string) (int64, error) {
	result, err := q.db.Exec(ctx, deleteChatLog, id)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) DeleteChatMessage(ctx context.Context, arg DeleteChatMessageParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteChatMessage, arg.ChatLogID, arg.Seq)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) GetChatLog(ctx context.Context, id string) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, getChatLog, id)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetChatLogBySite(ctx context.Context, siteID *string) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, getChatLogBySite, siteID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetSiteCurrentVersionID(ctx context.Context, id string) (*string, error) {
	row := q.db.QueryRow(ctx, getSiteCurrentVersionID, id)
...
func (q *Queries) ListChatMessages(ctx context.Context, arg ListChatMessagesParams) ([]AppChatMessage, error) {
	rows, err := q.db.Query(ctx, listChatMessages, arg.ChatLogID, arg.Seq, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) PruneChatMessages(ctx context.Context, arg PruneChatMessagesParams) (int64, error) {
	result, err := q.db.Exec(ctx, pruneChatMessages, arg.ChatLogID, arg.Limit)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) SetChatLogPanelEnabled(ctx context.Context, arg SetChatLogPanelEnabledParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, setChatLogPanelEnabled, arg.ID, arg.PanelEnabled)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetChatLogSite(ctx context.Context, arg SetChatLogSiteParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, setChatLogSite, arg.ID, arg.SiteID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
