...
const allocateChatSeq = `-- name: AllocateChatSeq :one
...
type AllocateChatSeqParams struct {
	ID      string
	Column2 int32
	OrgID   string
}
...
func (q *Queries) AllocateChatSeq(ctx context.Context, arg AllocateChatSeqParams) (int32, error) {
	row := q.db.QueryRow(ctx, allocateChatSeq, arg.ID, arg.Column2, arg.OrgID)
	var base_seq int32
	err := row.Scan(&base_seq)
	return base_seq, err
}
...
func (q *Queries) CountChatLogsForOrg(ctx context.Context, orgID string) (int64, error) {
	row := q.db.QueryRow(ctx, countChatLogsForOrg, orgID)
	var n int64
	err := row.Scan(&n)
	return n, err
}
...
func (q *Queries) CountChatMessages(ctx context.Context, arg CountChatMessagesParams) (int64, error) {
	row := q.db.QueryRow(ctx, countChatMessages, arg.ChatLogID, arg.OrgID)
	var n int64
	err := row.Scan(&n)
	return n, err
}
...
type CountFolderItemsParams struct {
	FolderID string
	OrgID    string
}

func (q *Queries) CountFolderItems(ctx context.Context, arg CountFolderItemsParams) (int64, error) {
	row := q.db.QueryRow(ctx, countFolderItems, arg.FolderID, arg.OrgID)
	var n int64
	err := row.Scan(&n)
	return n, err
}

const countOrgMemories = `-- name: CountOrgMemories :one
SELECT COUNT(*) FROM app.org_memories
WHERE org_id = $1
`

func (q *Queries) CountOrgMemories(ctx context.Context, orgID string) (int64, error) {
	row := q.db.QueryRow(ctx, countOrgMemories, orgID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CreateChatLog(ctx context.Context, arg CreateChatLogParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, createChatLog,
		arg.OrgID,
		arg.SiteID,
		arg.Title,
		arg.SourceTool,
...
func (q *Queries) DeleteAllowlistEntry(ctx context.Context, arg DeleteAllowlistEntryParams) error {
	_, err := q.db.Exec(ctx, deleteAllowlistEntry, arg.SiteID, arg.Email, arg.OrgID)
	return err
}

const deleteChatLog = `-- name: DeleteChatLog :execrows
DELETE FROM app.chat_logs WHERE id = $1 AND org_id = $2
`

type DeleteChatLogParams struct {
	ID    string
	OrgID string
}

func (q *Queries) DeleteChatLog(ctx context.Context, arg DeleteChatLogParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteChatLog, arg.ID, arg.OrgID)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) DeleteChatMessage(ctx context.Context, arg DeleteChatMessageParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteChatMessage, arg.ChatLogID, arg.Seq, arg.OrgID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const deleteContentChunksForSkill = `-- name: DeleteContentChunksForSkill :execrows
DELETE FROM app.org_content_chunks
WHERE org_id = $1 AND skill_id = $2
`

type DeleteContentChunksForSkillParams struct {
	OrgID   string
	SkillID *string
}

func (q *Queries) DeleteContentChunksForSkill(ctx context.Context, arg DeleteContentChunksForSkillParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteContentChunksForSkill, arg.OrgID, arg.SkillID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const deleteContentChunksForVersion = `-- name: DeleteContentChunksForVersion :execrows
DELETE FROM app.org_content_chunks
WHERE org_id = $1 AND version_id = $2
`

type DeleteContentChunksForVersionParams struct {
	OrgID     string
	VersionID *string
}

func (q *Queries) DeleteContentChunksForVersion(ctx context.Context, arg DeleteContentChunksForVersionParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteContentChunksForVersion, arg.OrgID, arg.VersionID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) DeleteDomain(ctx context.Context, arg DeleteDomainParams) (DeleteDomainRow, error) {
	row := q.db.QueryRow(ctx, deleteDomain, arg.ID, arg.OrgID)
...
type DeleteExpiredPreviewRoutesParams struct {
	ExpiresAt pgtype.Timestamptz
	OrgID     string
}
...
func (q *Queries) DeleteExpiredPreviewRoutes(ctx context.Context, arg DeleteExpiredPreviewRoutesParams) ([]string, error) {
	rows, err := q.db.Query(ctx, deleteExpiredPreviewRoutes, arg.ExpiresAt, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) DeleteExternalAllowlistEntriesForOrg(ctx context.Context, orgID string) error {
	_, err := q.db.Exec(ctx, deleteExternalAllowlistEntriesForOrg, orgID)
	return err
}
...
type DeleteHostRouteParams struct {
	Host  string
	OrgID string
}

func (q *Queries) DeleteHostRoute(ctx context.Context, arg DeleteHostRouteParams) error {
	_, err := q.db.Exec(ctx, deleteHostRoute, arg.Host, arg.OrgID)
	return err
}
...
const deleteOrgMemory = `-- name: DeleteOrgMemory :execrows
DELETE FROM app.org_memories
WHERE id = $1 AND org_id = $2
`

type DeleteOrgMemoryParams struct {
	ID    string
	OrgID string
}

func (q *Queries) DeleteOrgMemory(ctx context.Context, arg DeleteOrgMemoryParams) (int64, error) {
	result, err := q.db.Exec(ctx, deleteOrgMemory, arg.ID, arg.OrgID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) DeletePostCommentsForSubject(ctx context.Context, arg DeletePostCommentsForSubjectParams) error {
	_, err := q.db.Exec(ctx, deletePostCommentsForSubject, arg.SubjectType, arg.SubjectID, arg.OrgID)
	return err
}
...
func (q *Queries) DeletePostVote(ctx context.Context, arg DeletePostVoteParams) error {
	_, err := q.db.Exec(ctx, deletePostVote,
		arg.SubjectType,
		arg.SubjectID,
		arg.UserID,
		arg.OrgID,
...
func (q *Queries) DeletePostVotesForSubject(ctx context.Context, arg DeletePostVotesForSubjectParams) error {
	_, err := q.db.Exec(ctx, deletePostVotesForSubject, arg.SubjectType, arg.SubjectID, arg.OrgID)
	return err
}
...
type DeletePreviewRoutesForVersionParams struct {
	VersionID *string
	OrgID     string
}
...
func (q *Queries) DeletePreviewRoutesForVersion(ctx context.Context, arg DeletePreviewRoutesForVersionParams) ([]string, error) {
	rows, err := q.db.Query(ctx, deletePreviewRoutesForVersion, arg.VersionID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
WHERE site_id = $1
  AND org_id = $2
  AND kind = 'preview'
  AND version_id IS DISTINCT FROM $3
RETURNING host
`
...
func (q *Queries) DeleteSkill(ctx context.Context, arg DeleteSkillParams) (string, error) {
	row := q.db.QueryRow(ctx, deleteSkill, arg.ID, arg.OrgID)
	var id string
	err := row.Scan(&id)
	return id, err
}
...
type DeleteSkillFolderParams struct {
	ID    string
	OrgID string
}

// Memberships cascade; the skills themselves survive.
func (q *Queries) DeleteSkillFolder(ctx context.Context, arg DeleteSkillFolderParams) (string, error) {
	row := q.db.QueryRow(ctx, deleteSkillFolder, arg.ID, arg.OrgID)
	var id string
	err := row.Scan(&id)
	return id, err
}
...
type DeleteSkillFolderItemsForSkillParams struct {
	SkillID string
	OrgID   string
}
...
func (q *Queries) DeleteSkillFolderItemsForSkill(ctx context.Context, arg DeleteSkillFolderItemsForSkillParams) error {
	_, err := q.db.Exec(ctx, deleteSkillFolderItemsForSkill, arg.SkillID, arg.OrgID)
	return err
}
...
func (q *Queries) GetAllowlistEntryByEmail(ctx context.Context, arg GetAllowlistEntryByEmailParams) (AppAllowlistEntry, error) {
	row := q.db.QueryRow(ctx, getAllowlistEntryByEmail, arg.SiteID, arg.Email, arg.OrgID)
...
type GetChatLogParams struct {
	ID    string
	OrgID string
}

func (q *Queries) GetChatLog(ctx context.Context, arg GetChatLogParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, getChatLog, arg.ID, arg.OrgID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
type GetChatLogBySiteParams struct {
	SiteID *string
	OrgID  string
}

func (q *Queries) GetChatLogBySite(ctx context.Context, arg GetChatLogBySiteParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, getChatLogBySite, arg.SiteID, arg.OrgID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
const getChatLogsEnabled = `-- name: GetChatLogsEnabled :one
SELECT COALESCE(
...
func (q *Queries) GetChatLogsEnabled(ctx context.Context, id string) (bool, error) {
	row := q.db.QueryRow(ctx, getChatLogsEnabled, id)
	var chat_logs_enabled bool
	err := row.Scan(&chat_logs_enabled)
	return chat_logs_enabled, err
}
...
func (q *Queries) GetDomain(ctx context.Context, arg GetDomainParams) (AppDomain, error) {
...
func (q *Queries) GetHostRoute(ctx context.Context, arg GetHostRouteParams) (AppHostRoute, error) {
	row := q.db.QueryRow(ctx, getHostRoute, arg.Host, arg.OrgID)
	var i AppHostRoute
	err := row.Scan(
		&i.Host,
		&i.OrgID,
...
const getMemoryEnabled = `-- name: GetMemoryEnabled :one
SELECT memory_enabled FROM app.org_meta WHERE id = $1
`

func (q *Queries) GetMemoryEnabled(ctx context.Context, id string) (bool, error) {
	row := q.db.QueryRow(ctx, getMemoryEnabled, id)
	var memory_enabled bool
	err := row.Scan(&memory_enabled)
	return memory_enabled, err
}

const getMemoryIngest = `-- name: GetMemoryIngest :one
...
type GetMemoryIngestParams struct {
	OrgID      string
	SourceKind string
	SourceID   string
}

func (q *Queries) GetMemoryIngest(ctx context.Context, arg GetMemoryIngestParams) (AppOrgMemoryIngest, error) {
	row := q.db.QueryRow(ctx, getMemoryIngest, arg.OrgID, arg.SourceKind, arg.SourceID)
	var i AppOrgMemoryIngest
	err := row.Scan(
		&i.OrgID,
		&i.SourceKind,
		&i.SourceID,
...
const getOrgMemory = `-- name: GetOrgMemory :one
...
type GetOrgMemoryParams struct {
	ID    string
	OrgID string
}

type GetOrgMemoryRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) GetOrgMemory(ctx context.Context, arg GetOrgMemoryParams) (GetOrgMemoryRow, error) {
	row := q.db.QueryRow(ctx, getOrgMemory, arg.ID, arg.OrgID)
	var i GetOrgMemoryRow
	err := row.Scan(
		&i.ID,
		&i.OrgID,
		&i.Kind,
...
const getOrgMemoryByHash = `-- name: GetOrgMemoryByHash :one
SELECT id FROM app.org_memories
WHERE org_id = $1 AND content_hash = $2
`

type GetOrgMemoryByHashParams struct {
	OrgID       string
	ContentHash string
}
...
func (q *Queries) GetOrgMemoryByHash(ctx context.Context, arg GetOrgMemoryByHashParams) (string, error) {
	row := q.db.QueryRow(ctx, getOrgMemoryByHash, arg.OrgID, arg.ContentHash)
	var id string
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) GetPostVoteScore(ctx context.Context, arg GetPostVoteScoreParams) (int64, error) {
	row := q.db.QueryRow(ctx, getPostVoteScore, arg.SubjectType, arg.SubjectID, arg.OrgID)
	var score int64
	err := row.Scan(&score)
	return score, err
}
...
func (q *Queries) GetSite(ctx context.Context, arg GetSiteParams) (AppSite, error) {
...
type GetSiteAccessPolicyParams struct {
	SiteID string
	OrgID  string
}

func (q *Queries) GetSiteAccessPolicy(ctx context.Context, arg GetSiteAccessPolicyParams) (AppSiteAccessPolicy, error) {
	row := q.db.QueryRow(ctx, getSiteAccessPolicy, arg.SiteID, arg.OrgID)
...
const getSiteCurrentVersionID = `-- name: GetSiteCurrentVersionID :one
SELECT current_version_id
FROM app.sites
WHERE id = $1 AND org_id = $2
`

type GetSiteCurrentVersionIDParams struct {
	ID    string
	OrgID string
}

// The version stamp for an append while attached (NULL before first publish).
func (q *Queries) GetSiteCurrentVersionID(ctx context.Context, arg GetSiteCurrentVersionIDParams) (*string, error) {
	row := q.db.QueryRow(ctx, getSiteCurrentVersionID, arg.ID, arg.OrgID)
...
type GetSiteStorageBytesParams struct {
	ID    string
	OrgID string
}
...
func (q *Queries) GetSiteStorageBytes(ctx context.Context, arg GetSiteStorageBytesParams) (int64, error) {
	row := q.db.QueryRow(ctx, getSiteStorageBytes, arg.ID, arg.OrgID)
	var bytes int64
	err := row.Scan(&bytes)
	return bytes, err
}
...
type GetSiteVersionParams struct {
	ID    string
	OrgID string
}

func (q *Queries) GetSiteVersion(ctx context.Context, arg GetSiteVersionParams) (AppSiteVersion, error) {
	row := q.db.QueryRow(ctx, getSiteVersion, arg.ID, arg.OrgID)
	var i AppSiteVersion
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetSiteVersionByContentHash(ctx context.Context, arg GetSiteVersionByContentHashParams) (AppSiteVersion, error) {
	row := q.db.QueryRow(ctx, getSiteVersionByContentHash, arg.SiteID, arg.ContentHash, arg.OrgID)
	var i AppSiteVersion
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetSkillBySlug(ctx context.Context, arg GetSkillBySlugParams) (GetSkillBySlugRow, error) {
	row := q.db.QueryRow(ctx, getSkillBySlug, arg.Slug, arg.OrgID)
...
type GetSkillFolderParams struct {
	ID    string
	OrgID string
}

func (q *Queries) GetSkillFolder(ctx context.Context, arg GetSkillFolderParams) (AppSkillFolder, error) {
	row := q.db.QueryRow(ctx, getSkillFolder, arg.ID, arg.OrgID)
	var i AppSkillFolder
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
type GetSkillFolderBySlugParams struct {
	Slug  string
	OrgID string
}

func (q *Queries) GetSkillFolderBySlug(ctx context.Context, arg GetSkillFolderBySlugParams) (AppSkillFolder, error) {
	row := q.db.QueryRow(ctx, getSkillFolderBySlug, arg.Slug, arg.OrgID)
	var i AppSkillFolder
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetSkillVersion(ctx context.Context, arg GetSkillVersionParams) (AppSkillVersion, error) {
	row := q.db.QueryRow(ctx, getSkillVersion, arg.ID, arg.OrgID)
	var i AppSkillVersion
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) GetSkillVersionByContentHash(ctx context.Context, arg GetSkillVersionByContentHashParams) (AppSkillVersion, error) {
	row := q.db.QueryRow(ctx, getSkillVersionByContentHash, arg.SkillID, arg.ContentHash, arg.OrgID)
	var i AppSkillVersion
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) InsertChatMessage(ctx context.Context, arg InsertChatMessageParams) (AppChatMessage, error) {
...
type InsertContentChunkParams struct {
	OrgID          string
	SourceKind     string
	VersionID      *string
	SiteID         *string
...
func (q *Queries) InsertContentChunk(ctx context.Context, arg InsertContentChunkParams) error {
	_, err := q.db.Exec(ctx, insertContentChunk,
		arg.OrgID,
		arg.SourceKind,
		arg.VersionID,
		arg.SiteID,
...
type ListAllowlistEntriesParams struct {
	SiteID string
	OrgID  string
}

func (q *Queries) ListAllowlistEntries(ctx context.Context, arg ListAllowlistEntriesParams) ([]AppAllowlistEntry, error) {
	rows, err := q.db.Query(ctx, listAllowlistEntries, arg.SiteID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListAuditLog(ctx context.Context, arg ListAuditLogParams) ([]AppAuditLog, error) {
	rows, err := q.db.Query(ctx, listAuditLog, arg.Limit, arg.Offset, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListChatLogs(ctx context.Context, orgID string) ([]ListChatLogsRow, error) {
	rows, err := q.db.Query(ctx, listChatLogs, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListChatLogsRow{}
	for rows.Next() {
		var i ListChatLogsRow
		if err := rows.Scan(
			&i.ID,
			&i.OrgID,
			&i.SiteID,
...
func (q *Queries) ListChatMessages(ctx context.Context, arg ListChatMessagesParams) ([]AppChatMessage, error) {
...
func (q *Queries) ListCurrentSkillVersionsForGC(ctx context.Context, orgID string) ([]ListCurrentSkillVersionsForGCRow, error) {
	rows, err := q.db.Query(ctx, listCurrentSkillVersionsForGC, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListDomainsForSiteParams struct {
	SiteID string
	OrgID  string
}

func (q *Queries) ListDomainsForSite(ctx context.Context, arg ListDomainsForSiteParams) ([]AppDomain, error) {
	rows, err := q.db.Query(ctx, listDomainsForSite, arg.SiteID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
FROM app.sites s
WHERE s.feed_visible AND s.org_id = $2
ORDER BY s.created_at DESC
`

type ListFeedSitesParams struct {
	UserID string
	OrgID  string
}
...
func (q *Queries) ListFeedSites(ctx context.Context, arg ListFeedSitesParams) ([]ListFeedSitesRow, error) {
	rows, err := q.db.Query(ctx, listFeedSites, arg.UserID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListFeedSkillsParams struct {
	UserID string
	OrgID  string
}
...
func (q *Queries) ListFeedSkills(ctx context.Context, arg ListFeedSkillsParams) ([]ListFeedSkillsRow, error) {
	rows, err := q.db.Query(ctx, listFeedSkills, arg.UserID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListFolderSkillsParams struct {
	FolderID string
	OrgID    string
}
...
func (q *Queries) ListFolderSkills(ctx context.Context, arg ListFolderSkillsParams) ([]ListFolderSkillsRow, error) {
	rows, err := q.db.Query(ctx, listFolderSkills, arg.FolderID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
WHERE fi.skill_id = ANY($1::uuid[])
  AND fi.org_id = $2 AND f.org_id = $2
ORDER BY f.slug
`

type ListFoldersForSkillsParams struct {
	SkillIds []string
	OrgID    string
}
...
func (q *Queries) ListFoldersForSkills(ctx context.Context, arg ListFoldersForSkillsParams) ([]ListFoldersForSkillsRow, error) {
	rows, err := q.db.Query(ctx, listFoldersForSkills, arg.SkillIds, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListHostRoutesForSiteParams struct {
	SiteID string
	OrgID  string
}
...
func (q *Queries) ListHostRoutesForSite(ctx context.Context, arg ListHostRoutesForSiteParams) ([]AppHostRoute, error) {
	rows, err := q.db.Query(ctx, listHostRoutesForSite, arg.SiteID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const listOrgMemories = `-- name: ListOrgMemories :many
SELECT id, org_id, kind, content, content_hash, embedding_model, source_kind, source_id, source_tool, pinned, disabled, created_by, created_at, updated_at, last_used_at
FROM app.org_memories
WHERE org_id = $1
...
type ListOrgMemoriesParams struct {
	OrgID   string
	Column2 string
	Column3 string
	Column4 bool
...
type ListOrgMemoriesRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) ListOrgMemories(ctx context.Context, arg ListOrgMemoriesParams) ([]ListOrgMemoriesRow, error) {
	rows, err := q.db.Query(ctx, listOrgMemories,
		arg.OrgID,
		arg.Column2,
		arg.Column3,
		arg.Column4,
	...
	defer rows.Close()
	items := []ListOrgMemoriesRow{}
	for rows.Next() {
		var i ListOrgMemoriesRow
		if err := rows.Scan(
			&i.ID,
			&i.OrgID,
			&i.Kind,
...
const listPinnedOrgMemories = `-- name: ListPinnedOrgMemories :many
SELECT id, org_id, kind, content, content_hash, embedding_model, source_kind, source_id, source_tool, pinned, disabled, created_by, created_at, updated_at, last_used_at
FROM app.org_memories
...
type ListPinnedOrgMemoriesParams struct {
	OrgID string
	Limit int32
}

type ListPinnedOrgMemoriesRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) ListPinnedOrgMemories(ctx context.Context, arg ListPinnedOrgMemoriesParams) ([]ListPinnedOrgMemoriesRow, error) {
	rows, err := q.db.Query(ctx, listPinnedOrgMemories, arg.OrgID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListPinnedOrgMemoriesRow{}
	for rows.Next() {
		var i ListPinnedOrgMemoriesRow
		if err := rows.Scan(
			&i.ID,
			&i.OrgID,
			&i.Kind,
...
func (q *Queries) ListPostComments(ctx context.Context, arg ListPostCommentsParams) ([]AppPostComment, error) {
	rows, err := q.db.Query(ctx, listPostComments,
		arg.SubjectType,
		arg.SubjectID,
		arg.Limit,
		arg.OrgID,
...
func (q *Queries) ListPreviewRoutesForRebuild(ctx context.Context, orgID string) ([]ListPreviewRoutesForRebuildRow, error) {
	rows, err := q.db.Query(ctx, listPreviewRoutesForRebuild, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListPreviewRoutesForVersionParams struct {
	VersionID *string
	OrgID     string
}

func (q *Queries) ListPreviewRoutesForVersion(ctx context.Context, arg ListPreviewRoutesForVersionParams) ([]AppHostRoute, error) {
	rows, err := q.db.Query(ctx, listPreviewRoutesForVersion, arg.VersionID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListPublicSitesForOrg(ctx context.Context, orgID string) ([]AppSite, error) {
	rows, err := q.db.Query(ctx, listPublicSitesForOrg, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListPublishedSitesForRebuild(ctx context.Context, orgID string) ([]ListPublishedSitesForRebuildRow, error) {
	rows, err := q.db.Query(ctx, listPublishedSitesForRebuild, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListSiteStorageForOrg(ctx context.Context, orgID string) ([]ListSiteStorageForOrgRow, error) {
	rows, err := q.db.Query(ctx, listSiteStorageForOrg, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
type ListSiteVersionsParams struct {
	SiteID string
	OrgID  string
}

func (q *Queries) ListSiteVersions(ctx context.Context, arg ListSiteVersionsParams) ([]AppSiteVersion, error) {
	rows, err := q.db.Query(ctx, listSiteVersions, arg.SiteID, arg.OrgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListSites(ctx context.Context, orgID string) ([]AppSite, error) {
...
func (q *Queries) ListSkillFolders(ctx context.Context, orgID string) ([]ListSkillFoldersRow, error) {
	rows, err := q.db.Query(ctx, listSkillFolders, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
LEFT JOIN app.skill_versions v ON v.id = sk.current_version_id
WHERE sk.org_id = $1
  AND (sk.current_version_id IS NOT NULL OR sk.owner_user_id = $2::uuid)
  AND (
        $3::text = ''
        OR sk.slug ILIKE '%' || $3 || '%'
        OR COALESCE(sk.title, '') ILIKE '%' || $3 || '%'
        OR COALESCE(sk.description, '') ILIKE '%' || $3 || '%'
      )
  AND (
        ($4::text = '' AND NOT $5::boolean)
        OR EXISTS (
            SELECT 1
            FROM app.skill_folder_items fi
            JOIN app.skill_folders f ON f.id = fi.folder_id
            WHERE fi.skill_id = sk.id
              AND fi.org_id = $1 AND f.org_id = $1
              AND ($4::text = '' OR f.slug = $4)
              AND (NOT $5::boolean OR fi.is_preset)
        )
      )
ORDER BY sk.created_at DESC
`
...
func (q *Queries) ListVersionsForGC(ctx context.Context, orgID string) ([]ListVersionsForGCRow, error) {
	rows, err := q.db.Query(ctx, listVersionsForGC, orgID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const lockChatLogAppend = `-- name: LockChatLogAppend :exec
...
const lockOrgChatLogQuota = `-- name: LockOrgChatLogQuota :exec
...
func (q *Queries) LockOrgChatLogQuota(ctx context.Context, dollar_1 string) error {
	_, err := q.db.Exec(ctx, lockOrgChatLogQuota, dollar_1)
	return err
}
...
const lockOrgMemoryQuota = `-- name: LockOrgMemoryQuota :exec
...
func (q *Queries) LockOrgMemoryQuota(ctx context.Context, dollar_1 string) error {
	_, err := q.db.Exec(ctx, lockOrgMemoryQuota, dollar_1)
	return err
}
...
type NextSkillVersionNoParams struct {
	SkillID string
	OrgID   string
}

func (q *Queries) NextSkillVersionNo(ctx context.Context, arg NextSkillVersionNoParams) (int32, error) {
	row := q.db.QueryRow(ctx, nextSkillVersionNo, arg.SkillID, arg.OrgID)
...
func (q *Queries) NextVersionNo(ctx context.Context, arg NextVersionNoParams) (int32, error) {
	row := q.db.QueryRow(ctx, nextVersionNo, arg.SiteID, arg.OrgID)
	var next_version_no int32
	err := row.Scan(&next_version_no)
	return next_version_no, err
}

const pruneChatMessages = `-- name: PruneChatMessages :execrows
...
type PruneChatMessagesParams struct {
	ChatLogID string
	Limit     int32
	OrgID     string
}
...
func (q *Queries) PruneChatMessages(ctx context.Context, arg PruneChatMessagesParams) (int64, error) {
	result, err := q.db.Exec(ctx, pruneChatMessages, arg.ChatLogID, arg.Limit, arg.OrgID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) RemoveSkillFolderItem(ctx context.Context, arg RemoveSkillFolderItemParams) (string, error) {
	row := q.db.QueryRow(ctx, removeSkillFolderItem, arg.FolderID, arg.SkillID, arg.OrgID)
	var skill_id string
...
func (q *Queries) RenameSkillFolder(ctx context.Context, arg RenameSkillFolderParams) (AppSkillFolder, error) {
	row := q.db.QueryRow(ctx, renameSkillFolder, arg.ID, arg.Title, arg.OrgID)
	var i AppSkillFolder
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
const searchContentChunks = `-- name: SearchContentChunks :many
...
type SearchContentChunksParams struct {
	OrgID          string
	Column2        string
	EmbeddingModel string
	Limit          int32
...
type SearchContentChunksRow struct {
	ID         string
	SourceKind string
	Path       string
	ChunkSeq   int32
	Content    string
	SiteSlug   pgtype.Text
...
func (q *Queries) SearchContentChunks(ctx context.Context, arg SearchContentChunksParams) ([]SearchContentChunksRow, error) {
	rows, err := q.db.Query(ctx, searchContentChunks,
		arg.OrgID,
		arg.Column2,
		arg.EmbeddingModel,
		arg.Limit,
	...
	defer rows.Close()
	items := []SearchContentChunksRow{}
	for rows.Next() {
		var i SearchContentChunksRow
		if err := rows.Scan(
			&i.ID,
			&i.SourceKind,
			&i.Path,
...
const searchOrgMemories = `-- name: SearchOrgMemories :many
SELECT id, org_id, kind, content, content_hash, embedding_model, source_kind, source_id, source_tool, pinned, disabled, created_by, created_at, updated_at, last_used_at,
...
type SearchOrgMemoriesParams struct {
	OrgID          string
	Column2        string
	EmbeddingModel string
	Limit          int32
...
type SearchOrgMemoriesRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) SearchOrgMemories(ctx context.Context, arg SearchOrgMemoriesParams) ([]SearchOrgMemoriesRow, error) {
	rows, err := q.db.Query(ctx, searchOrgMemories,
		arg.OrgID,
		arg.Column2,
		arg.EmbeddingModel,
		arg.Limit,
	...
	defer rows.Close()
	items := []SearchOrgMemoriesRow{}
	for rows.Next() {
		var i SearchOrgMemoriesRow
		if err := rows.Scan(
			&i.ID,
			&i.OrgID,
			&i.Kind,
...
func (q *Queries) SetChatLogAllowMemberEdits(ctx context.Context, arg SetChatLogAllowMemberEditsParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, setChatLogAllowMemberEdits, arg.ID, arg.AllowMemberEdits, arg.OrgID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetChatLogPanelEnabled(ctx context.Context, arg SetChatLogPanelEnabledParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, setChatLogPanelEnabled, arg.ID, arg.PanelEnabled, arg.OrgID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
const setChatLogSite = `-- name: SetChatLogSite :one
UPDATE app.chat_logs
SET site_id = $2
WHERE id = $1 AND org_id = $3
RETURNING id, org_id, site_id, title, source_tool, panel_enabled, next_seq, created_by, created_at, allow_member_edits
...
func (q *Queries) SetChatLogSite(ctx context.Context, arg SetChatLogSiteParams) (AppChatLog, error) {
	row := q.db.QueryRow(ctx, setChatLogSite, arg.ID, arg.SiteID, arg.OrgID)
	var i AppChatLog
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
const setChatLogsEnabled = `-- name: SetChatLogsEnabled :exec
UPDATE app.org_meta
SET chat_logs_enabled = $2
WHERE id = $1
`

type SetChatLogsEnabledParams struct {
	ID              string
	ChatLogsEnabled bool
}

func (q *Queries) SetChatLogsEnabled(ctx context.Context, arg SetChatLogsEnabledParams) error {
	_, err := q.db.Exec(ctx, setChatLogsEnabled, arg.ID, arg.ChatLogsEnabled)
	return err
}
...
func (q *Queries) SetCurrentVersion(ctx context.Context, arg SetCurrentVersionParams) error {
	_, err := q.db.Exec(ctx, setCurrentVersion, arg.ID, arg.CurrentVersionID, arg.OrgID)
	return err
}
...
const setMemoryEnabled = `-- name: SetMemoryEnabled :exec
UPDATE app.org_meta
SET memory_enabled = $2
WHERE id = $1
`

type SetMemoryEnabledParams struct {
	ID            string
	MemoryEnabled bool
}
...
const setOrgMemoryDisabled = `-- name: SetOrgMemoryDisabled :one
...
type SetOrgMemoryDisabledParams struct {
	ID       string
	OrgID    string
	Disabled bool
}

type SetOrgMemoryDisabledRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) SetOrgMemoryDisabled(ctx context.Context, arg SetOrgMemoryDisabledParams) (SetOrgMemoryDisabledRow, error) {
	row := q.db.QueryRow(ctx, setOrgMemoryDisabled, arg.ID, arg.OrgID, arg.Disabled)
	var i SetOrgMemoryDisabledRow
	err := row.Scan(
		&i.ID,
		&i.OrgID,
		&i.Kind,
...
const setOrgMemoryPinned = `-- name: SetOrgMemoryPinned :one
UPDATE app.org_memories
...
type SetOrgMemoryPinnedParams struct {
	ID     string
	OrgID  string
	Pinned bool
}

type SetOrgMemoryPinnedRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) SetOrgMemoryPinned(ctx context.Context, arg SetOrgMemoryPinnedParams) (SetOrgMemoryPinnedRow, error) {
	row := q.db.QueryRow(ctx, setOrgMemoryPinned, arg.ID, arg.OrgID, arg.Pinned)
	var i SetOrgMemoryPinnedRow
	err := row.Scan(
		&i.ID,
		&i.OrgID,
		&i.Kind,
...
func (q *Queries) SetSiteAccessMode(ctx context.Context, arg SetSiteAccessModeParams) error {
	_, err := q.db.Exec(ctx, setSiteAccessMode, arg.ID, arg.AccessMode, arg.OrgID)
	return err
}
...
func (q *Queries) SetSiteAllowMemberEdits(ctx context.Context, arg SetSiteAllowMemberEditsParams) (AppSite, error) {
	row := q.db.QueryRow(ctx, setSiteAllowMemberEdits, arg.ID, arg.AllowMemberEdits, arg.OrgID)
	var i AppSite
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetSiteFeedMeta(ctx context.Context, arg SetSiteFeedMetaParams) (AppSite, error) {
	row := q.db.QueryRow(ctx, setSiteFeedMeta,
		arg.ID,
		arg.Title,
		arg.Description,
		arg.OrgID,
...
func (q *Queries) SetSiteFeedVisible(ctx context.Context, arg SetSiteFeedVisibleParams) (AppSite, error) {
	row := q.db.QueryRow(ctx, setSiteFeedVisible, arg.ID, arg.FeedVisible, arg.OrgID)
	var i AppSite
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetSkillAllowMemberEdits(ctx context.Context, arg SetSkillAllowMemberEditsParams) (AppSkill, error) {
	row := q.db.QueryRow(ctx, setSkillAllowMemberEdits, arg.ID, arg.AllowMemberEdits, arg.OrgID)
	var i AppSkill
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetSkillCurrentVersion(ctx context.Context, arg SetSkillCurrentVersionParams) error {
	_, err := q.db.Exec(ctx, setSkillCurrentVersion, arg.ID, arg.CurrentVersionID, arg.OrgID)
	return err
}
...
func (q *Queries) SetSkillFeedVisible(ctx context.Context, arg SetSkillFeedVisibleParams) (AppSkill, error) {
	row := q.db.QueryRow(ctx, setSkillFeedVisible, arg.ID, arg.FeedVisible, arg.OrgID)
	var i AppSkill
	err := row.Scan(
		&i.ID,
		&i.OrgID,
...
func (q *Queries) SetSkillFolderItemPreset(ctx context.Context, arg SetSkillFolderItemPresetParams) (SetSkillFolderItemPresetRow, error) {
	row := q.db.QueryRow(ctx, setSkillFolderItemPreset,
		arg.FolderID,
		arg.SkillID,
		arg.IsPreset,
		arg.OrgID,
...
func (q *Queries) SetSkillMeta(ctx context.Context, arg SetSkillMetaParams) (AppSkill, error) {
	row := q.db.QueryRow(ctx, setSkillMeta,
		arg.ID,
		arg.Title,
		arg.Description,
		arg.OrgID,
...
func (q *Queries) SetVersionPreviewExpiry(ctx context.Context, arg SetVersionPreviewExpiryParams) error {
	_, err := q.db.Exec(ctx, setVersionPreviewExpiry, arg.ID, arg.PreviewExpiresAt, arg.OrgID)
	return err
}
...
const touchOrgMemoriesUsed = `-- name: TouchOrgMemoriesUsed :exec
UPDATE app.org_memories
SET last_used_at = now()
WHERE org_id = $1 AND id = ANY($2::uuid[])
`

type TouchOrgMemoriesUsedParams struct {
	OrgID   string
	Column2 []string
}
...
func (q *Queries) UpdateDomainStatus(ctx context.Context, arg UpdateDomainStatusParams) (AppDomain, error) {
	row := q.db.QueryRow(ctx, updateDomainStatus,
		arg.ID,
		arg.VerifyStatus,
		arg.TlsStatus,
		arg.OrgID,
...
type UpdateOrgMemoryContentParams struct {
	ID             string
	OrgID          string
	Content        string
	ContentHash    string
...
type UpdateOrgMemoryContentRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) UpdateOrgMemoryContent(ctx context.Context, arg UpdateOrgMemoryContentParams) (UpdateOrgMemoryContentRow, error) {
	row := q.db.QueryRow(ctx, updateOrgMemoryContent,
		arg.ID,
		arg.OrgID,
		arg.Content,
		arg.ContentHash,
	...
	var i UpdateOrgMemoryContentRow
	err := row.Scan(
		&i.ID,
		&i.OrgID,
		&i.Kind,
...
const upsertMemoryIngest = `-- name: UpsertMemoryIngest :exec
...
type UpsertMemoryIngestParams struct {
	OrgID      string
	SourceKind string
	SourceID   string
	ThroughSeq int64
...
func (q *Queries) UpsertMemoryIngest(ctx context.Context, arg UpsertMemoryIngestParams) error {
	_, err := q.db.Exec(ctx, upsertMemoryIngest,
		arg.OrgID,
		arg.SourceKind,
		arg.SourceID,
		arg.ThroughSeq,
...
type UpsertOrgMemoryParams struct {
	OrgID          string
	Kind           string
	Content        string
	ContentHash    string
...
type UpsertOrgMemoryRow struct {
	ID             string
	OrgID          string
	Kind           string
	Content        string
...
func (q *Queries) UpsertOrgMemory(ctx context.Context, arg UpsertOrgMemoryParams) (UpsertOrgMemoryRow, error) {
	row := q.db.QueryRow(ctx, upsertOrgMemory,
		arg.OrgID,
		arg.Kind,
		arg.Content,
		arg.ContentHash,
